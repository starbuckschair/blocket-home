...
!(function (n, t, e) {
  ...
  function x(n, t) {
    return R(n)
      ? new E.LatLng(n[0], n[1])
      : !t || !n || n instanceof E.LatLng
      ? n
      : new E.LatLng(n.lat, n.lng);
  }
  function P(n, t) {
    return R(n)
  ...
  function M(n) {
    function t() {
      var n = this;
      return (
        (n.onAdd = n.onRemove = n.draw = function () {}), E.OverlayView.call(n)
      );
    }
        ...
        n.each(t, function (n, t) {
          h(e, function (e) {
            var a = e instanceof B,
              ...
              f = s ? e.$.get(0) : e;
            E.event["add" + (s ? "Dom" : "") + "Listener" + (i ? "Once" : "")](
              f,
              n,
              function (n) {
                h(t, function (t) {
